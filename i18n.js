    ...
    const translations = {
        en: {
            ...
            about: {
                ...
                introBody: 'Electrical engineer who learned how production scanners are built before learning how the devices on the wafers behind them actually work. Most useful at the intersection of RF, devices, and process integration, where the same person can read the data, work the trade space, and decide what ships.',
        ...
        fr: {
            ...
            about: {
                ...
                introBody: "Ingénieur électrique qui a appris comment se construisent les scanners de production avant d'apprendre comment fonctionnent réellement les dispositifs gravés sur les wafers qui en sortent. Le plus utile à l'intersection de la RF, des dispositifs et de l'intégration de procédé, là où une seule personne peut lire les données, travailler l'espace de compromis, et décider de ce qui part en production.",
                slideProfileTitle: 'Louis Antoine',
