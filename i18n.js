    ...
    const translations = {
        en: {
            ...
            about: {
                ...
                introBody: 'Electrical engineer working across production floor equipment, device physics, and mmWave RF. Comfortable reading the data, working the trade space, and deciding what ships.',
        ...
        fr: {
            ...
            hero: {
                ...
                desc1: "Ingénieur matériel sur la RF mmWave, les dispositifs GaN, les procédés semi-conducteurs. Intéressé par l'architecture, l'intégration, l'espace de compromis.",
            ...
            about: {
                ...
                introBody: "Ingénieur électrique travaillant sur les équipements de plancher de production, la physique des dispositifs et la RF mmWave. À l'aise pour lire les données, travailler l'espace de compromis et décider de ce qui part en production.",
                slideProfileTitle: 'Louis Antoine',
        ...
        es: {
            ...
            hero: {
                ...
                desc1: 'Ingeniero de hardware en RF mmWave, dispositivos GaN, procesos de semiconductores. Interesado en arquitectura, integración, espacio de compromiso.',
            ...
            about: {
                ...
                introBody: 'Ingeniero eléctrico que trabaja en equipos de planta de producción, física de dispositivos y RF mmWave. Cómodo leyendo los datos, trabajando el espacio de compromiso y decidiendo qué se envía a producción.',
                slideProfileTitle: 'Louis Antoine',
